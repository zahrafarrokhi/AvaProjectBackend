...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('email', 'phone_number', 'password', 'is_active', 'is_staff')
...
class CustomToken(admin.ModelAdmin):
    readonly_fields = ('user', 'created_at', 'updated_at')
    search_fields = ('user', 'exp_date', 'tokenid')
    list_display = ('user', 'exp_date', 'tokenid')
    ordering = ('created_at', 'user',)
    fields = None
    fieldsets = (
        ('info', {'fields': ('user', 'device_info', 'tokenid',)}),
        ('times', {'fields': ('created_at', 'updated_at', 'exp_date')}),
    )
